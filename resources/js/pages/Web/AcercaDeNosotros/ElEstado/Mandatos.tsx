...
const eventos = [
    {
        ...
        imagenes: [
            { src: '/images/Mandatos/ovido1.jpg', alt: 'Ovidio Alejandro González', tipo: 'cuadrada' },
            { src: '/images/Mandatos/ovido2.jpg', alt: 'Ovidio Alejandro González', tipo: 'cuadrada' },
        ],
        texto: (
            <>
                <p>
    ...
    },
    {
        ...
        imagenes: [
            { src: '/images/Mandatos/chavez.jpg', alt: 'Hugo Rafael Chávez Frías', tipo: 'horizontal' },
            { src: '/images/Mandatos/DavidDeLima.jpg', alt: 'David De Lima', tipo: 'horizontal' },
        ],
        texto: (
            <>
                <p>
    ...
    },
    {
        ...
        imagenes: [
            { src: '/images/Mandatos/TarekWilliamSaab.jpg', alt: 'Tarek William Saab', tipo: 'horizontal' },
        ],
        texto: (
            <>
                <p>
    ...
    },
    {
        ...
        imagenes: [
            { src: '/images/Mandatos/aristobulo.jpg', alt: 'Aristóbulo Istúriz', tipo: 'horizontal' },
        ],
        texto: (
            <>
                <p>
    ...
    },
    {
        ...
        imagenes: [
            { src: '/images/Mandatos/JorgeArreaza.jpg', alt: 'Jorge Arreaza', tipo: 'horizontal' },
            { src: '/images/Mandatos/NelsonMoreno.jpg', alt: 'Nelson Moreno', tipo: 'horizontal' },
        ],
        texto: (
            <>
                <p>
    ...
    },
    {
        ...
        imagenes: [
            {
                src: '/images/Mandatos/AntonioBarretoSira.jpg',
    ...
    },
    {
        ...
        imagenes: [
            { src: '/images/Mandatos/LuisMarcano.jpg', alt: 'Luis José Marcano', tipo: 'vertical' },
            { src: '/images/Mandatos/LuisMarcano2.jpg', alt: 'Luis José Marcano', tipo: 'vertical' },
        ],
        texto: (
            <>
                <p>
...
export default function Mandatos() {
    return (
        <>
            ...
            <AcercaDeNosotrosNav seccion="elEstado" activo="mandatos" />
                        ...
                        <div className="mx-auto max-w-7xl px-6 py-16 lg:px-8">
                            <div className="relative max-w-4xl">
                                ...
                                <p className="mt-6 max-w-2xl text-base leading-7 text-blue-100 sm:text-lg">
                                    Conoce la evolución del Poder Ejecutivo del Estado Anzoátegui y los gobernantes que han dirigido la entidad a través de su historia contemporánea.
                                </p>
                            </div>
                        </div>
                    </section>
                    ...
                    <section className="mx-auto max-w-7xl px-6 pb-20 pt-16 lg:px-8">
                        <div className="rounded-2xl bg-blue-950 px-8 py-10 text-center shadow-sm sm:px-12">
                            ...
                            <p className="mx-auto mt-5 max-w-4xl text-base leading-8 text-blue-100 sm:text-lg">
                                Los distintos mandatos que han formado parte de la historia de la
                                Gobernación del Estado Anzoátegui reflejan la evolución de sus
                                <strong className="font-semibold text-white"> instituciones, autoridades y gestión pública</strong>
                                a través del tiempo.
                            </p>
                        </div>
                    </section>
