...
interface EstadoPlan { id: number; nombre: string; activo?: boolean; }
...
interface Props { estadosPlan: EstadoPlan[]; plan?: Plan; }
        ...
        <form onSubmit={submit} className="space-y-6">
                ...
                <div className="rounded-xl border bg-card p-6 lg:col-span-2">
                    ...
                    <div className="grid grid-cols-1 gap-5 md:grid-cols-2">
                        <div className="space-y-2">
                            ...
                            <Input id="titulo" value={data.titulo}
                                onChange={(e) => setData('titulo', e.target.value)}
                                placeholder="Ej. Rehabilitación de la Avenida Principal" disabled={processing} />
                        ...
                        <div className="space-y-2 md:col-span-1">
                            ...
                            <Input id="ubicacion" value={data.ubicacion}
                                onChange={(e) => setData('ubicacion', e.target.value)}
                                placeholder="Ej. Barcelona, Guanta, Lechería..." disabled={processing} />
                        ...
                        <div className="space-y-2 md:col-span-2">
                            ...
                            <Textarea id="descripcion" value={data.descripcion}
                                onChange={(e) => setData('descripcion', e.target.value)}
                                placeholder="Describe detalladamente el plan, proyecto, objetivo, alcance, etc."
                                rows={9} disabled={processing} className="resize-none" />
                ...
                <div className="rounded-xl border bg-card p-6">
                    ...
                    <div className="space-y-5">
                        ...
                        <div>
                            ...
                            <DatePicker value={fechaFinalizacion}
                                onChange={(value) => {
                        ...
                        <div className="space-y-2">
                            ...
                            <select id="estado_id" value={data.estado_id}
                                onChange={(e) => setData('estado_id', e.target.value)} disabled={processing}
                        ...
                        <div className="flex items-center justify-between rounded-lg border p-4">
                            <div className="pr-4">
                                ...
                                <p className="mt-1 text-xs text-muted-foreground">Permitir que el plan aparezca públicamente.</p>
                            </div>
                            <Switch checked={data.publicado}
                                onCheckedChange={(checked) => setData('publicado', checked)} disabled={processing} />
                        </div>
            ...
            <div className="rounded-xl border bg-card p-6">
                <div className="mb-6 flex items-center justify-between">
                    <div>
                        <h2 className="text-lg font-semibold">Imágenes del plan</h2>
                ...
                <div className="grid gap-8 lg:grid-cols-2">
                    ...
                    <div className="space-y-4">
                        <div>
                            ...
                            <p className="mt-1 text-xs text-muted-foreground">
                                Será la imagen principal del plan en la página web.
                            </p>
                        </div>
                        ...
                        <div className="relative aspect-video overflow-hidden rounded-xl border bg-muted">
                            {portadaPreview ? (
                                ...
                                <img src={`/storage/${plan.imagen_portada}`} alt="Portada actual" className="h-full w-full object-cover" />
                            ) : (
                        ...
                        >
                            ...
                            {plan?.imagen_portada ? 'Cambiar portada' : 'Seleccionar portada'}
                        </Button>
                    ...
                    <div className="space-y-4">
                        <div>
                            ...
                            <p className="mt-1 text-xs text-muted-foreground">
                                Agrega imágenes adicionales para mostrar en el proyecto.
                            </p>
                        </div>
